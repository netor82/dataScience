...
Dado que los arhivos de datos provienen de fuentes diferentes, se hizo necesario aplicar un proceso de limpieza para poder cruzar la información. Para ello, se necesitó una tercera fuente de datos -países- y cambiar valores.
...
1. Renombrar las columnas al igual que las columnas en los otros dataset para luego hacer los joins.
1. Revisar qué valores de dfCountries no hacen correspondencia con los códigos o nombres usados en los otros datasets.
